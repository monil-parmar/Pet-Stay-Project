if (!window.__PETSTAY_AUTH_CHECK_LOADED__) {
  ...
  const amplifyAuthConfig = {
    ...
    userPoolId: 'us-east-1_QIxGKKFzG', // Cognito User Pool ID
    userPoolWebClientId: '7pk31b8a5ak2b7aj42qimaibhc', // Cognito User Pool Client ID
    oauth: {
      domain: 'us-east-1qixgkkfzg.auth.us-east-1.amazoncognito.com', // Cognito Domain
      scope: ['email', 'openid', 'phone'], // OAuth scopes
      redirectSignIn: 'https://main.d3esln33qx1ws1.amplifyapp.com/admin-frontend/post-login.html', // Redirect Sign In URL
      redirectSignOut: 'https://main.d3esln33qx1ws1.amplifyapp.com/index.html', // Redirect Sign Out URL
